...
--awful.util.tagnames = { "", "", "", "", "" }
awful.layout.suit.spiral.dwindle.mirror = true
awful.layout.layouts = {
    ...
    --ain.layout.cascade,
    --ain.layout.cascade.tile,
    --ain.layout.centerwork,
    --ain.layout.centerwork.horizontal,
    --ain.layout.termfair,
    --ain.layout.termfair.center,
}
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,  }, "d",
    function ()
        awful.spawn(string.format("rofi -lines 12 -padding 24 -width 60 -location 0 -show drun -sidebar-mode -columns 3",
    ...
    awful.key({ modkey }, "F1", function () awful.util.spawn( browser1 ) end,
        {description = browser1, group = "function keys"}),
    awful.key({ modkey }, "F2", function () awful.util.spawn( "remmina" ) end,
        {description = "remmina", group = "function keys" }),
    awful.key({ modkey }, "F3", function () awful.util.spawn( mailclient ) end,
        {description = mailclient ,group = "function keys" }),
    awful.key({ modkey }, "F4", function () awful.util.spawn( editorgui ) end,
    ...
    awful.key({ modkey }, "F6", function () awful.util.spawn( "kotatogram-desktop" ) end,
        {description = "kotatogram-desktop" , group = "function keys" }),
    awful.key({ modkey }, "F7", function () awful.util.spawn( "virtualbox" ) end,
        {description = virtualmachine , group = "function keys" }),
    awful.key({ modkey }, "F8", function () awful.util.spawn( "cmus" ) end,
        {description = "cmus" , group = "function keys" }),
    awful.key({ modkey }, "F9", function () awful.util.spawn( "gnome-calculator") end,
        {description = "gnome-calculator" , group = "function keys" }),
    awful.key({ modkey }, "F10", function () awful.util.spawn("teamviewer" ) end,
        {description = "teamviewer" , group = "function keys" }),
    awful.key({ modkey }, "F11", function () awful.util.spawn( "anydesk" ) end,
        {description = "anydesk" , group = "function keys" }),
    awful.key({ modkey }, "F12", function () awful.util.spawn( filemanager ) end,
        {description = filemanager , group = "function keys" }),

    -- super + ...
    awful.key({ modkey }, "c", function () awful.util.spawn( "gnome-calculator" ) end,
        {description = "Calculator", group = "super"}),
    awful.key({ modkey }, "e", function () awful.util.spawn(filemanager ) end,
        {description = "run pcmanfm", group = "super"}),
   ...
   -- awful.key({ modkey }, "r", function () awful.util.spawn( "rofi-theme-selector" ) end,
    ...
    awful.key({ modkey }, "l",  function () awful.util.spawn( "arcolinux-logout" ) end,
    ...
    -- ctrl + shift + ...
    awful.key({ modkey1, "Shift"  }, "Escape", function() awful.util.spawn("bashtop") end),
    ...
    awful.key({ }, "Print", function () awful.util.spawn("flameshot gui") end,
        {description = "Capturar Region", group = "screenshots"}),
    awful.key({ modkey1           }, "Print", function () awful.util.spawn( "flameshot screen -c" ) end,
        {description = "Captura Pantalla Entera", group = "screenshots"}),
    awful.key({ modkey1, "Shift"  }, "Print", function() awful.util.spawn("flameshot full -p $HOME/Imágenes/Capturas") end,
        {description = "Captura Full Archivo", group = "screenshots"}),
